...
**Xem thêm:** [Module 10 mục 10.7](../doc/03-cowork-setup.md) (An toàn Cowork), [Module 09 mục 9.6](07-evaluation.md#96-review-giữa-các-bước--in-progress-review) (Review giữa các bước), [Module 03 mục 3.5](03-prompt-engineering.md#35-task-decomposition--khi-nào-và-cách-tách-task-advanced) (Task Decomposition — prevention ở cấp độ planning)
