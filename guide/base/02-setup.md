...
>
> So sánh Project Instructions với Folder Instructions (Cowork): xem [`reference/config-architecture.md`](../reference/config-architecture.md), mục "Lớp 3 và Lớp 5".
...
**Chi tiết:** Xem [Context Management, mục 4.9](04-context-management.md#49-context-sync-practices--quản-lý-knowledge-across-surfaces) và [Recipe 5.17 — Hybrid Workflow](05-tools-features.md#517-recipe-hybrid-workflow--chat--project--cowork).
...
Bạn có thể tạo Custom Style bằng 2 cách: upload writing sample hoặc viết instructions trực tiếp.

**Chi tiết cách tạo Custom Style và templates cho Phenikaa-X:** xem [Custom Style Reference](../doc/06-custom-style.md).
...
- [ ] (Tùy chọn) Tạo Custom Style nếu cần (xem [Custom Style Reference](../doc/06-custom-style.md))
