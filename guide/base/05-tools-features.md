...
[Nguồn: Anthropic Help Center — Claude Plans]
...
[Nguồn: Anthropic Help Center — Artifacts]
...
[Nguồn: Anthropic Help Center — Web Search]
...
[Nguồn: Anthropic Help Center — Keyboard shortcuts]
...
[Nguồn: Anthropic Help Center — Search and tools] [Cập nhật 03/2026]
...
**Xem [Template T-22](../doc/02-template-library.md#t-22-cowork-task-plan-prompt-package) để biết cấu trúc Prompt Package đầy đủ.**
...
Tại sao không làm 1 task: context window đầy ở module thứ 3-4, quality giảm rõ rệt — kinh nghiệm từ các lần update trước. Tại sao không làm 10 tasks: các sections liên quan (ví dụ [Mistakes & Fixes, nhóm 6](06-mistakes-fixes.md#86-nhóm-6-lỗi-lan-truyền-trong-workflow-nhiều-bước) và các recovery patterns) cần được viết trong cùng 1 context để đảm bảo coherence; tách quá nhỏ làm mất coherence đó.
