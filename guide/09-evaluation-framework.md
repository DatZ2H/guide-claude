...
Hoặc cung cấp ví dụ (xem Module 03, Nguyên tắc 2: Use Examples).
...
| Backup có chưa? | Không có bản gốc để so sánh hoặc rollback | Xem Module 10, mục 10.7 về quy trình backup |
...
**Cross-reference:** Template T-20 (In-Progress Review Checklist, Module 07) là phiên bản printable của mục này.

---

**Tiếp theo:**

- Module 03: Prompt Engineering -- nắm vững nguyên tắc để output đạt chất lượng cao từ đầu
- Module 08: Mistakes & Fixes -- khắc phục lỗi cụ thể
