...
**Thứ tự ưu tiên CLAUDE.md:** Managed > Project > User > Local.

> [!NOTE]
> Đây là priority cho **CLAUDE.md instructions** — khác với **settings.json** priority (xem [section 1.7](#17-settings-hierarchy)). Settings có thêm CLI arguments level và thứ tự Local/Project đảo ngược.
