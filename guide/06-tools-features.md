...
| Tính năng | Free | Pro ($20/th) | Team ($25/ng/th) | Enterprise |
|-----------|------|-------------|-------------------|------------|
| Chat cơ bản | Có | Có | Có | Có |
| Web Search | Có | Có | Có | Có |
| Artifacts | Có | Có | Có | Có |
| Upload files | Có | Có | Có | Có |
| Projects | 5 projects | Không giới hạn | + Shared | + Admin |
| File Creation (docx, pptx...) | Có | Có | Có | Có |
| Styles (preset + custom) | Có | Có | Có | Có |
| Memory | Không | Có | Có | Có |
| Extended Thinking | Hạn chế | Có | Có | Có |
| Chọn model | Không | Có | Có | Có |
| MCP Connectors | Không | Có | Có | Có |
| Research | Không | Có | Có | Có |
| Dung lượng sử dụng | Thấp | 5x Free | 5x Free | Custom |

**Lưu ý:** Bảng này cập nhật đến 02/2026. Anthropic thường xuyên cập nhật features -- kiểm tra claude.ai cho thông tin mới nhất.
...
|-------|----------|-------------|--------|
| **Claude Opus 4.6** | Suy luận sâu nhất, Adaptive Thinking | Debug phức tạp, phân tích multi-system, kiến trúc hệ thống | Chậm nhất |
| **Claude Sonnet 4.6** | Cân bằng tốc độ và chất lượng, Adaptive Thinking, 1M context (beta) | Công việc hàng ngày, viết tài liệu, code review | Trung bình |
...
## 6.3 Adaptive Thinking (trước đây: Extended Thinking)
...
Adaptive Thinking cho phép Claude "suy nghĩ sâu hơn" trước khi trả lời. Claude tạo thinking block nội bộ (hiển thị cho bạn xem trên Claude.ai), sau đó đưa ra câu trả lời dựa trên suy luận đó.
...
**Bỏ "think step-by-step".** Khi bật Adaptive Thinking, Claude TỰ ĐỘNG suy luận từng bước. Không cần thêm chain-of-thought instructions -- thực tế, thêm vào có thể làm giảm hiệu quả.

**Đơn giản hóa prompt.** Adaptive Thinking hoạt động tốt nhất với prompt rõ ràng, ít "steering". Để Claude tự quyết định cách suy nghĩ.
...
| Task cần phân tích sâu | Adaptive Thinking |
...
| **Adaptive Thinking** | Search and tools > Extended thinking | Có | Debug phức tạp, suy luận sâu |
